"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }var _Card = require('../models/Card'); var _Card2 = _interopRequireDefault(_Card);

class CardController {
  async index(req, res) {
    try {
      const card = await _Card2.default.findAll({
  ...
  async show(req, res) {
    try {
      ...
      const card = await _Card2.default.findOne({
        where: {
          id,
          deck_id: req.deckId,
        },
  ...
  async store(req, res) {
    try {
      ...
      const newCard = await _Card2.default.create({
